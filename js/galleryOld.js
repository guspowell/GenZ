...
function fadeOutImages() {
  $(".grid-item").click(function() {
    ...
    setDescriptionPosition();
    $("#carousel.container").fadeIn("fast");
    setUpCarousel();
...
function changeImageText() {
  ...
  $('.carousel-control.right').click(function() {
    ...
    if ( $(window).width() < 430 ) {
      $(".image-info.description").fadeIn(0);
    } else {
...
imagesJson = {
    "01-ellie": [
        ...
        },
        {
            ...
            "text": {
                ...
                "body": "As with Eligh, Ellie told us she admired David Bowie for his ability to adapt to the times whilst staying true to his core values."
            }
        },
        {
            "image": [
            ...
            "text": {
                "title": "Ageless Era",
                "body": "Vivienne Westwood was also held in high esteem by Ellie, as she loved Westwood's refusal to be defined by age."
            }
        },
        {
            "image": [
        ...
        },
        {
            ...
            "text": {
                ...
                "body": "Ellie had a vintage typewriter as she enjoyed the novelty of the analogue experience it offered."
            }
        }
    ],
    "02-bella-and-jo": [
        {
            "image": [
                "02-bellajo-01@1x.jpg",
                "02-bellajo-01@2x.jpg"
            ],
            "text": {
                "title": "Strength through Inclusion",
                "body": "Joanna and Bella believed that every member of their all female robotics team added a unique skill, allowing them to achieve more than if they worked on their own."
            }
        },
        {
            "image": [
                "02-bellajo-02@1x.jpg",
                "02-bellajo-02@2x.jpg"
            ],
            "text": {
        ...
        {
            "image": [
                "02-bellajo-03@1x.jpg",
                "02-bellajo-03@2x.jpg"
            ],
            "text": {
        ...
        {
            "image": [
                "02-bellajo-04@1x.jpg",
                "02-bellajo-04@2x.jpg"
            ],
            "text": {
        ...
        {
            "image": [
                "02-bellajo-05@1x.jpg",
                "02-bellajo-05@2x.jpg"
            ],
            "text": {
    ...
    "03-eligh": [
        ...
        },
        {
            ...
            "text": {
                "title": "Emphasis on Narrative",
                "body": "Eligh preferred games that were visually striking and emotive."
            }
        },
        {
            "image": [
            ...
            "text": {
                ...
                "body": "As with Ellie, Eligh was a fan of David Bowie’s chameleonic personality. He believed that the ability to adapt would be key to sucess in our unstable global environment."
            }
        }
    ],
    "04-elliot": [
        {
            ...
            "text": {
                "title": "Appetite for self-expression",
        ...
        },
        {
            ...
            "text": {
                ...
                "body": "Elliot's finger had bent after years of gaming to fit the shape of his Playstation controller."
            }
        },
        {
            "image": [
        ...
        },
        {
            ...
            "text": {
                "title": "Under the Surface",
                "body": " As with Joanna and Bella, Elliot told us he enjoys taking apart products as it him helps him to understand how they work."
            }
        }
    ],
    "05-alessandra": [
        ...
        },
        {
            ...
            "text": {
                ...
                "body": "Alessandra adores ballet as it offered a non-verbal means of self-expression."
            }
        }
    ],
    "06-lewis": [
        ...
        },
        {
            ...
            "text": {
                ...
                "body": "Lewis was acutely aware of issues surrounding environmental instability, believing it to be a communal challenge we all face together."
            }
        },
        {
            "image": [
            ...
            "text": {
                "title": "Small World",
                "body": "Furthermore Lewis told us of how the global connection enabled by the internet has made the world’s population feel more tight-knit."
            }
        },
        {
            "image": [
        ...
        },
        {
            ...
            "text": {
                ...
                "body": "Lewis’ focus on functionality and value for money stretched beyond the kit he’d chosen for his Arctic challenge."
            }
        }
    ],
    "07-simran": [
    ...
    "08-rose": [
        ...
        },
        {
            ...
            "text": {
                ...
                "body": "Rose discovers new brands and products online through social channels such as Instagram as well as visiting stores in person."
            }
        },
        {
            "image": [
            ...
            "text": {
                ...
                "body": "Rose told us that she prefers the video format to blog posts as they give the viewer a better sense of the true character of the author."
            }
        },
        {
            "image": [
    ...
    "09-henry": [
        ...
        },
        {
            ...
            "text": {
                "title": "Omnivorous Career Ambitions",
        ...
        },
        {
            ...
            "text": {
                ...
                "body": "Henry cited that the best thing about being an entrepreneur is the opportunitity to meet inspiring people."
            }
        },
        {
            "image": [
    ...
    "10-jaysea": [
        {
            ...
            "text": {
                ...
                "body": "Jaysea is the youngest certified yoga instructor in the USA."
            }
        },
        {
            "image": [
        ...
        },
        {
            ...
            "text": {
                ...
                "body": "Jaysea enjoyed exercising outdoors as it helped her to reconnect to the physical world."
            }
        },
        {
            "image": [
